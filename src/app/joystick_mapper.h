...
public:
    ...
    [[nodiscard]] int16_t deadzone() const;
    ...
    [[nodiscard]] uint8_t mapAxis(int16_t pal_value) const;
    ...
    [[nodiscard]] uint8_t mapButton(uint8_t pal_button, bool pressed) const;
    ...
    [[nodiscard]] JoystickState processEvent(int16_t axis_x, int16_t axis_y,
    ...
    [[nodiscard]] const JoystickState& state(uint8_t joystick_id) const;
