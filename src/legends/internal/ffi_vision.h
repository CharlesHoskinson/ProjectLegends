...
// ─────────────────────────────────────────────────────────────────────────────
// Result Codes (use unified legends_error_t from ffi_core.h)
// ─────────────────────────────────────────────────────────────────────────────

/* Vision functions use the unified legends_error_t from ffi_core.h.
 * Vision-specific error codes are in the 300-399 range:
 *   LEGENDS_ERR_VISION_NO_FRAMEBUFFER    = 300
 *   LEGENDS_ERR_VISION_NOT_DIRTY         = 301
 *   LEGENDS_ERR_VISION_INVALID_FORMAT    = 302
 *   LEGENDS_ERR_VISION_OVERLAY_NOT_FOUND = 303
 *
 * Common error codes also apply:
 *   LEGENDS_ERR_NOT_INITIALIZED          = 3
 *   LEGENDS_ERR_INVALID_PARAM            = 1
 *   LEGENDS_ERR_BUFFER_TOO_SMALL         = 6
 *   LEGENDS_ERR_OUT_OF_MEMORY            = 7
 */

/* Backward compatibility typedefs */
typedef legends_error_t VisionResult;
#define VISION_OK                      LEGENDS_OK
#define VISION_ERROR_NOT_INITIALIZED   LEGENDS_ERR_NOT_INITIALIZED
#define VISION_ERROR_INVALID_PARAM     LEGENDS_ERR_INVALID_PARAM
#define VISION_ERROR_BUFFER_TOO_SMALL  LEGENDS_ERR_BUFFER_TOO_SMALL
#define VISION_ERROR_NO_FRAMEBUFFER    LEGENDS_ERR_VISION_NO_FRAMEBUFFER
#define VISION_ERROR_NOT_DIRTY         LEGENDS_ERR_VISION_NOT_DIRTY
#define VISION_ERROR_INVALID_FORMAT    LEGENDS_ERR_VISION_INVALID_FORMAT
#define VISION_ERROR_ALLOCATION        LEGENDS_ERR_OUT_OF_MEMORY
#define VISION_ERROR_OVERLAY_NOT_FOUND LEGENDS_ERR_VISION_OVERLAY_NOT_FOUND
#define VISION_ERROR_INTERNAL          LEGENDS_ERR_INTERNAL
