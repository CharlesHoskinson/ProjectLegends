...
#ifdef DOSBOX_LIBRARY_MODE
	/* Library mode: throw exception instead of terminating host process.
	 * The exception will be caught by safe_call at the API boundary.
	 * This allows the host to handle the error gracefully.
	 */
	throw dosbox::FatalException(buf, __FILE__, __LINE__);
#else
