...
TEST(AudioMixerTest, MixTwoSilenceBuffers) {
    ...
    AudioMixer::mix(out.data(), a.data(), b.data(), 8);
...
TEST(AudioMixerTest, MixSilenceAndSignal) {
    ...
    AudioMixer::mix(out.data(), silence.data(), signal.data(), 4);
...
TEST(AudioMixerTest, MixSignalPlusSignal) {
    ...
    AudioMixer::mix(out.data(), a.data(), b.data(), 4);
...
TEST(AudioMixerTest, MixPositiveOverflowClampsToMax) {
    ...
    AudioMixer::mix(out.data(), a.data(), b.data(), 1);
...
TEST(AudioMixerTest, MixLargeBuffer) {
    ...
    AudioMixer::mix(out.data(), a.data(), b.data(), kSize);
...
TEST(AudioMixerTest, MixAdditiveAddsToExisting) {
    ...
    AudioMixer::mixAdditive(out.data(), src.data(), 4);
...
TEST(AudioMixerTest, MixAdditiveClamps) {
    ...
    AudioMixer::mixAdditive(out.data(), src.data(), 1);
...
TEST(AudioMixerTest, ApplyVolume_Unity_NoChange) {
    ...
    AudioMixer::applyVolume(buf.data(), 4, 1.0f);
...
TEST(AudioMixerTest, ApplyVolume_Zero_Silence) {
    ...
    AudioMixer::applyVolume(buf.data(), 4, 0.0f);
...
TEST(AudioMixerTest, ApplyVolume_Half) {
    ...
    AudioMixer::applyVolume(buf.data(), 4, 0.5f);
...
TEST(AudioMixerTest, ApplyVolume_Double_Clamps) {
    ...
    AudioMixer::applyVolume(buf.data(), 2, 2.0f);
...
TEST(AudioMixerTest, ApplyVolume_Negative_Inverts) {
    ...
    AudioMixer::applyVolume(buf.data(), 2, -1.0f);
...
TEST(AudioMixerTest, ApplyVolume_PreservesSign) {
    ...
    AudioMixer::applyVolume(buf.data(), 2, 0.5f);
...
TEST(AudioMixerTest, MixN_ZeroSources_Silence) {
    ...
    AudioMixer::mixN(out.data(), nullptr, 0, 4);
...
TEST(AudioMixerTest, MixN_OneSource_Copy) {
    ...
    const int16_t* sources[] = {src.data()};
    std::array<int16_t, 4> out = {};

    AudioMixer::mixN(out.data(), sources, 1, 4);
...
TEST(AudioMixerTest, MixN_ThreeSources) {
    ...
    const int16_t* sources[] = {a.data(), b.data(), c.data()};
    std::array<int16_t, 4> out = {};

    AudioMixer::mixN(out.data(), sources, 3, 4);
...
TEST(AudioMixerTest, MixWithZeroCount_NullPtrs) {
    // Should not crash when count is 0, even with null pointers.
    AudioMixer::mix(nullptr, nullptr, nullptr, 0);
    AudioMixer::mixAdditive(nullptr, nullptr, 0);
    AudioMixer::applyVolume(nullptr, 0, 1.0f);
    AudioMixer::mixN(nullptr, nullptr, 0, 0);
}
