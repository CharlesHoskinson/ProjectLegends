 ...
 * - LEGENDS_ERR_ALREADY_RUNNING (-5) - tested here (if applicable)
...
TEST_F(ErrorCodesTest, AllErrorCodesHaveExpectedValues) {
    ...
    EXPECT_EQ(LEGENDS_ERR_ALREADY_RUNNING, -5);
...
TEST_F(ErrorCodesTest, ErrorCodesAreNegative) {
    ...
    EXPECT_LT(LEGENDS_ERR_ALREADY_RUNNING, 0);
